...
export default function useIrismodService() {
  ...
  const QueryDefinition = (service_name: string,  options: any) => {
    ...
    return useQuery([key], () => {
      ...
      return  client.IrismodService.query.queryDefinition(service_name).then( res => res.data );
    }, options);
  }
  ...
  const QueryBinding = (service_name: string, provider: string,  options: any) => {
    ...
    return useQuery([key], () => {
      ...
      return  client.IrismodService.query.queryBinding(service_name, provider).then( res => res.data );
    }, options);
  }
  ...
  const QueryBindings = (service_name: string, query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      return  client.IrismodService.query.queryBindings(service_name, query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
  ...
  const QueryWithdrawAddress = (owner: string,  options: any) => {
    ...
    return useQuery([key], () => {
      const { owner } = key
      return  client.IrismodService.query.queryWithdrawAddress(owner).then( res => res.data );
    }, options);
  }
  ...
  const QueryRequestContext = (request_context_id: string,  options: any) => {
    ...
    return useQuery([key], () => {
      ...
      return  client.IrismodService.query.queryRequestContext(request_context_id).then( res => res.data );
    }, options);
  }
  ...
  const QueryRequest = (request_id: string,  options: any) => {
    ...
    return useQuery([key], () => {
      ...
      return  client.IrismodService.query.queryRequest(request_id).then( res => res.data );
    }, options);
  }
  ...
  const QueryRequests = (service_name: string, provider: string, query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.IrismodService.query.queryRequests(service_name, provider, query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QueryRequestsByReqCtx = (request_context_id: string, batch_counter: string, query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.IrismodService.query.queryRequestsByReqCtx(request_context_id, batch_counter, query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QueryResponse = (request_id: string,  options: any) => {
    ...
    return useQuery([key], () => {
      const { request_id } = key
      return  client.IrismodService.query.queryResponse(request_id).then( res => res.data );
    }, options);
  }
  ...
  const QueryResponses = (request_context_id: string, batch_counter: string, query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.IrismodService.query.queryResponses(request_context_id, batch_counter, query ?? undefined).then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
  ...
  const QueryEarnedFees = (provider: string,  options: any) => {
    ...
    return useQuery([key], () => {
      const { provider } = key
      return  client.IrismodService.query.queryEarnedFees(provider).then( res => res.data );
    }, options);
  }
  ...
  const QuerySchema = (schema_name: string,  options: any) => {
    ...
    return useQuery([key], () => {
      ...
      return  client.IrismodService.query.querySchema(schema_name).then( res => res.data );
    }, options);
  }
  ...
  const QueryParams = ( options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({pageParam = 1}: { pageParam?: number}) => {
      ...
      query['pagination.offset']= (pageParam-1)*perPage;
      query['pagination.count_total']= true;
      return  client.IrismodService.query.queryParams().then( res => ({...res.data,pageParam}) );
    }, {...options,
      getNextPageParam: (lastPage, allPages) => { if ((lastPage.pagination?.total ?? 0) >((lastPage.pageParam ?? 0) * perPage)) {return lastPage.pageParam+1 } else {return undefined}},
      getPreviousPageParam: (firstPage, allPages) => { if (firstPage.pageParam==1) { return undefined } else { return firstPage.pageParam-1}}
    }
