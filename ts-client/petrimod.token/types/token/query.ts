...
export class QueryClientImpl implements Query {
  ...
  Token(request: QueryTokenRequest): Promise<QueryTokenResponse> {
    ...
    const promise = this.rpc.request("petrimod.token.Query", "Token", data);
