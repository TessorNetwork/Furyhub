...
import { Module as PetrimodCoinswap, msgTypes as PetrimodCoinswapMsgTypes } from './petrimod.coinswap'
import { Module as PetrimodFarm, msgTypes as PetrimodFarmMsgTypes } from './petrimod.farm'
import { Module as PetrimodHtlc, msgTypes as PetrimodHtlcMsgTypes } from './petrimod.htlc'
import { Module as PetrimodOracle, msgTypes as PetrimodOracleMsgTypes } from './petrimod.oracle'
import { Module as PetrimodRandom, msgTypes as PetrimodRandomMsgTypes } from './petrimod.random'
import { Module as PetrimodRecord, msgTypes as PetrimodRecordMsgTypes } from './petrimod.record'
import { Module as PetrimodService, msgTypes as PetrimodServiceMsgTypes } from './petrimod.service'
import { Module as PetrimodToken, msgTypes as PetrimodTokenMsgTypes } from './petrimod.token'
...
const Client = IgniteClient.plugin([
    CosmosAuthV1Beta1, CosmosAuthzV1Beta1, CosmosBankV1Beta1, CosmosBaseTendermintV1Beta1, CosmosCrisisV1Beta1, CosmosDistributionV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosGovV1, CosmosGovV1Beta1, CosmosNftV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosStakingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, IbcApplicationsInterchainAccountsControllerV1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1, IrismodMt, PetrihubGuardian, PetrihubMint, PetrimodCoinswap, PetrimodFarm, PetrimodHtlc, PetrimodOracle, PetrimodRandom, PetrimodRecord, PetrimodService, PetrimodToken, TibcAppsMtTransferV1, TibcAppsNftTransferV1, TibcCoreClientV1, TibcCorePacketV1, TibcCoreRoutingV1
]);
...
const registry = new Registry([
  ...
  ...PetrimodCoinswapMsgTypes,
  ...PetrimodFarmMsgTypes,
  ...PetrimodHtlcMsgTypes,
  ...PetrimodOracleMsgTypes,
  ...PetrimodRandomMsgTypes,
  ...PetrimodRecordMsgTypes,
  ...PetrimodServiceMsgTypes,
  ...PetrimodTokenMsgTypes,
