...
import { ClassTrace } from "./mt_transfer";
...
export class QueryClientImpl implements Query {
  ...
  ClassTrace(request: QueryClassTraceRequest): Promise<QueryClassTraceResponse> {
    ...
    const promise = this.rpc.request("tibc.apps.mt_transfer.v1.Query", "ClassTrace", data);
  ...
  ClassTraces(request: QueryClassTracesRequest): Promise<QueryClassTracesResponse> {
    ...
    const promise = this.rpc.request("tibc.apps.mt_transfer.v1.Query", "ClassTraces", data);
