...
export class MsgClientImpl implements Msg {
  ...
  CreatePool(request: MsgCreatePool): Promise<MsgCreatePoolResponse> {
    ...
    const promise = this.rpc.request("irismod.farm.Msg", "CreatePool", data);
  ...
  CreatePoolWithCommunityPool(
    ...
    const promise = this.rpc.request("irismod.farm.Msg", "CreatePoolWithCommunityPool", data);
