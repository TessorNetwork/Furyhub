...
export interface V1QueryRelayersResponse {
...
/**
 * @title tibc/core/client/v1/client.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @summary ClientStates queries all the TIBC light clients of a chain.
   ...
   * @summary ClientState queries an TIBC light client.
   * @request GET:/ibc/core/client/v1beta1/client_states/{chain_name}
   */
  queryClientState = (chainName: string, params: RequestParams = {}) =>
    this.request<V1QueryClientStateResponse, RpcStatus>({
      path: `/ibc/core/client/v1beta1/client_states/${chainName}`,
      method: "GET",
      format: "json",
      ...params,
    });
...
client.
 * @request GET:/ibc/core/client/v1beta1/consensus_states/{chain_name}
 */
  queryConsensusStates = (
    ...
    this.request<V1QueryConsensusStatesResponse, RpcStatus>({
      path: `/ibc/core/client/v1beta1/consensus_states/${chainName}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
...
a given height.
 * @request GET:/ibc/core/client/v1beta1/consensus_states/{chain_name}/revision/{revision_number}/height/{revision_height}
 */
  queryConsensusState = (
    chainName: string,
    ...
    this.request<V1QueryConsensusStateResponse, RpcStatus>({
      path: `/ibc/core/client/v1beta1/consensus_states/${chainName}/revision/${revisionNumber}/height/${revisionHeight}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
 ...
 * @tags Query
 * @name QueryRelayers
 * @summary Relayers queries all the relayers associated with a given
client.
 * @request GET:/ibc/core/client/v1beta1/relayers/{chain_name}
 */
  queryRelayers = (chainName: string, params: RequestParams = {}) =>
    this.request<V1QueryRelayersResponse, RpcStatus>({
      path: `/ibc/core/client/v1beta1/relayers/${chainName}`,
      method: "GET",
      format: "json",
      ...params,
    });
