...
export { MsgRefundServiceDeposit, MsgRespondService, MsgPauseRequestContext, MsgUpdateServiceBinding, MsgEnableServiceBinding, MsgCallService, MsgStartRequestContext, MsgDisableServiceBinding, MsgKillRequestContext, MsgSetWithdrawAddress, MsgWithdrawEarnedFees, MsgDefineService, MsgBindService, MsgUpdateRequestContext };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgRefundServiceDeposit({ value }: msgRefundServiceDepositParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgRefundServiceDeposit", value: MsgRefundServiceDeposit.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgRespondService({ value }: msgRespondServiceParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgRespondService", value: MsgRespondService.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgPauseRequestContext({ value }: msgPauseRequestContextParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgPauseRequestContext", value: MsgPauseRequestContext.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateServiceBinding({ value }: msgUpdateServiceBindingParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgUpdateServiceBinding", value: MsgUpdateServiceBinding.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgEnableServiceBinding({ value }: msgEnableServiceBindingParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgEnableServiceBinding", value: MsgEnableServiceBinding.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCallService({ value }: msgCallServiceParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgCallService", value: MsgCallService.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgStartRequestContext({ value }: msgStartRequestContextParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgStartRequestContext", value: MsgStartRequestContext.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDisableServiceBinding({ value }: msgDisableServiceBindingParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgDisableServiceBinding", value: MsgDisableServiceBinding.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgKillRequestContext({ value }: msgKillRequestContextParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgKillRequestContext", value: MsgKillRequestContext.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgSetWithdrawAddress({ value }: msgSetWithdrawAddressParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgSetWithdrawAddress", value: MsgSetWithdrawAddress.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgWithdrawEarnedFees({ value }: msgWithdrawEarnedFeesParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgWithdrawEarnedFees", value: MsgWithdrawEarnedFees.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDefineService({ value }: msgDefineServiceParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgDefineService", value: MsgDefineService.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgBindService({ value }: msgBindServiceParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgBindService", value: MsgBindService.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateRequestContext({ value }: msgUpdateRequestContextParams): EncodeObject {
			try {
				return { typeUrl: "/petrimod.service.MsgUpdateRequestContext", value: MsgUpdateRequestContext.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			PetrimodService: new SDKModule(test)
		},
		registry: msgTypes
  }
}
