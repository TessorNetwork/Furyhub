...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/irismod/service/bindings/{service_name}
   */
  queryBindings = (
    serviceName: string,
    query?: {
    ...
    this.request<ServiceQueryBindingsResponse, RpcStatus>({
      path: `/irismod/service/bindings/${serviceName}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/irismod/service/contexts/{request_context_id}
   */
  queryRequestContext = (requestContextId: string, params: RequestParams = {}) =>
    this.request<ServiceQueryRequestContextResponse, RpcStatus>({
      path: `/irismod/service/contexts/${requestContextId}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/irismod/service/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ServiceQueryParamsResponse, RpcStatus>({
      path: `/irismod/service/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/irismod/service/requests/{request_context_id}/{batch_counter}
   */
  queryRequestsByReqCtx = (
    ...
    this.request<ServiceQueryRequestsByReqCtxResponse, RpcStatus>({
      path: `/irismod/service/requests/${requestContextId}/${batchCounter}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/irismod/service/requests/{service_name}/{provider}
   */
  queryRequests = (
    serviceName: string,
    provider: string,
    ...
    this.request<ServiceQueryRequestsResponse, RpcStatus>({
      path: `/irismod/service/requests/${serviceName}/${provider}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/irismod/service/responses/{request_context_id}/{batch_counter}
   */
  queryResponses = (
    requestContextId: string,
    batchCounter: string,
    ...
    this.request<ServiceQueryResponsesResponse, RpcStatus>({
      path: `/irismod/service/responses/${requestContextId}/${batchCounter}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
