...
::tip 
You must use Furyhub [v1.1.1](https://github.com/tessornetwork/furyhub/releases/tag/v1.1.1)[ ](https://github.com/tessornetwork/furyhub/releases/tag/v1.0.1) to initialize your node::
