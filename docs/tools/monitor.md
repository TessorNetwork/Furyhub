...
GRIDhub metrics also contains tendermint metrics, Visit [tendermint metrics](https://github.com/gridironprotocol/tendermint/blob/gridironprotocol/master/docs/tendermint-core/metrics.md) for more information.
