...
- [coinswap/coinswap.proto](#coinswap/coinswap.proto)
    - [Input](#petrimod.coinswap.Input)
    - [Output](#petrimod.coinswap.Output)
    - [Params](#petrimod.coinswap.Params)
    - [Pool](#petrimod.coinswap.Pool)
  
- [coinswap/genesis.proto](#coinswap/genesis.proto)
    - [GenesisState](#petrimod.coinswap.GenesisState)
...
- [coinswap/query.proto](#coinswap/query.proto)
    - [PoolInfo](#petrimod.coinswap.PoolInfo)
    - [QueryLiquidityPoolRequest](#petrimod.coinswap.QueryLiquidityPoolRequest)
    - [QueryLiquidityPoolResponse](#petrimod.coinswap.QueryLiquidityPoolResponse)
    - [QueryLiquidityPoolsRequest](#petrimod.coinswap.QueryLiquidityPoolsRequest)
    - [QueryLiquidityPoolsResponse](#petrimod.coinswap.QueryLiquidityPoolsResponse)
  
    - [Query](#petrimod.coinswap.Query)
  
- [coinswap/tx.proto](#coinswap/tx.proto)
    - [MsgAddLiquidity](#petrimod.coinswap.MsgAddLiquidity)
    - [MsgAddLiquidityResponse](#petrimod.coinswap.MsgAddLiquidityResponse)
    - [MsgRemoveLiquidity](#petrimod.coinswap.MsgRemoveLiquidity)
    - [MsgRemoveLiquidityResponse](#petrimod.coinswap.MsgRemoveLiquidityResponse)
    - [MsgSwapCoinResponse](#petrimod.coinswap.MsgSwapCoinResponse)
    - [MsgSwapOrder](#petrimod.coinswap.MsgSwapOrder)
  
    - [Msg](#petrimod.coinswap.Msg)
...
- [farm/farm.proto](#farm/farm.proto)
    - [FarmInfo](#petrimod.farm.FarmInfo)
    - [FarmPool](#petrimod.farm.FarmPool)
    - [Params](#petrimod.farm.Params)
    - [RewardRule](#petrimod.farm.RewardRule)
  
- [farm/genesis.proto](#farm/genesis.proto)
    - [GenesisState](#petrimod.farm.GenesisState)
  
- [farm/query.proto](#farm/query.proto)
    - [FarmPoolEntry](#petrimod.farm.FarmPoolEntry)
    - [LockedInfo](#petrimod.farm.LockedInfo)
    - [QueryFarmPoolRequest](#petrimod.farm.QueryFarmPoolRequest)
    - [QueryFarmPoolResponse](#petrimod.farm.QueryFarmPoolResponse)
    - [QueryFarmPoolsRequest](#petrimod.farm.QueryFarmPoolsRequest)
    - [QueryFarmPoolsResponse](#petrimod.farm.QueryFarmPoolsResponse)
    - [QueryFarmerRequest](#petrimod.farm.QueryFarmerRequest)
    - [QueryFarmerResponse](#petrimod.farm.QueryFarmerResponse)
    - [QueryParamsRequest](#petrimod.farm.QueryParamsRequest)
    - [QueryParamsResponse](#petrimod.farm.QueryParamsResponse)
  
    - [Query](#petrimod.farm.Query)
  
- [farm/tx.proto](#farm/tx.proto)
    - [MsgAdjustPool](#petrimod.farm.MsgAdjustPool)
    - [MsgAdjustPoolResponse](#petrimod.farm.MsgAdjustPoolResponse)
    - [MsgCreatePool](#petrimod.farm.MsgCreatePool)
    - [MsgCreatePoolResponse](#petrimod.farm.MsgCreatePoolResponse)
    - [MsgDestroyPool](#petrimod.farm.MsgDestroyPool)
    - [MsgDestroyPoolResponse](#petrimod.farm.MsgDestroyPoolResponse)
    - [MsgHarvest](#petrimod.farm.MsgHarvest)
    - [MsgHarvestResponse](#petrimod.farm.MsgHarvestResponse)
    - [MsgStake](#petrimod.farm.MsgStake)
    - [MsgStakeResponse](#petrimod.farm.MsgStakeResponse)
    - [MsgUnstake](#petrimod.farm.MsgUnstake)
    - [MsgUnstakeResponse](#petrimod.farm.MsgUnstakeResponse)
  
    - [Msg](#petrimod.farm.Msg)
...
- [htlc/htlc.proto](#htlc/htlc.proto)
    - [AssetParam](#petrimod.htlc.AssetParam)
    - [AssetSupply](#petrimod.htlc.AssetSupply)
    - [HTLC](#petrimod.htlc.HTLC)
    - [Params](#petrimod.htlc.Params)
    - [SupplyLimit](#petrimod.htlc.SupplyLimit)
  
    - [HTLCState](#petrimod.htlc.HTLCState)
    - [SwapDirection](#petrimod.htlc.SwapDirection)
  
- [htlc/genesis.proto](#htlc/genesis.proto)
    - [GenesisState](#petrimod.htlc.GenesisState)
  
- [htlc/query.proto](#htlc/query.proto)
    - [QueryAssetSuppliesRequest](#petrimod.htlc.QueryAssetSuppliesRequest)
    - [QueryAssetSuppliesResponse](#petrimod.htlc.QueryAssetSuppliesResponse)
    - [QueryAssetSupplyRequest](#petrimod.htlc.QueryAssetSupplyRequest)
    - [QueryAssetSupplyResponse](#petrimod.htlc.QueryAssetSupplyResponse)
    - [QueryHTLCRequest](#petrimod.htlc.QueryHTLCRequest)
    - [QueryHTLCResponse](#petrimod.htlc.QueryHTLCResponse)
    - [QueryParamsRequest](#petrimod.htlc.QueryParamsRequest)
    - [QueryParamsResponse](#petrimod.htlc.QueryParamsResponse)
  
    - [Query](#petrimod.htlc.Query)
  
- [htlc/tx.proto](#htlc/tx.proto)
    - [MsgClaimHTLC](#petrimod.htlc.MsgClaimHTLC)
    - [MsgClaimHTLCResponse](#petrimod.htlc.MsgClaimHTLCResponse)
    - [MsgCreateHTLC](#petrimod.htlc.MsgCreateHTLC)
    - [MsgCreateHTLCResponse](#petrimod.htlc.MsgCreateHTLCResponse)
  
    - [Msg](#petrimod.htlc.Msg)
...
- [nft/nft.proto](#nft/nft.proto)
    - [BaseNFT](#petrimod.nft.BaseNFT)
    - [Collection](#petrimod.nft.Collection)
    - [Denom](#petrimod.nft.Denom)
    - [IDCollection](#petrimod.nft.IDCollection)
    - [Owner](#petrimod.nft.Owner)
  
- [nft/genesis.proto](#nft/genesis.proto)
    - [GenesisState](#petrimod.nft.GenesisState)
  
- [nft/query.proto](#nft/query.proto)
    - [QueryCollectionRequest](#petrimod.nft.QueryCollectionRequest)
    - [QueryCollectionResponse](#petrimod.nft.QueryCollectionResponse)
    - [QueryDenomRequest](#petrimod.nft.QueryDenomRequest)
    - [QueryDenomResponse](#petrimod.nft.QueryDenomResponse)
    - [QueryDenomsRequest](#petrimod.nft.QueryDenomsRequest)
    - [QueryDenomsResponse](#petrimod.nft.QueryDenomsResponse)
    - [QueryNFTRequest](#petrimod.nft.QueryNFTRequest)
    - [QueryNFTResponse](#petrimod.nft.QueryNFTResponse)
    - [QueryOwnerRequest](#petrimod.nft.QueryOwnerRequest)
    - [QueryOwnerResponse](#petrimod.nft.QueryOwnerResponse)
    - [QuerySupplyRequest](#petrimod.nft.QuerySupplyRequest)
    - [QuerySupplyResponse](#petrimod.nft.QuerySupplyResponse)
  
    - [Query](#petrimod.nft.Query)
  
- [nft/tx.proto](#nft/tx.proto)
    - [MsgBurnNFT](#petrimod.nft.MsgBurnNFT)
    - [MsgBurnNFTResponse](#petrimod.nft.MsgBurnNFTResponse)
    - [MsgEditNFT](#petrimod.nft.MsgEditNFT)
    - [MsgEditNFTResponse](#petrimod.nft.MsgEditNFTResponse)
    - [MsgIssueDenom](#petrimod.nft.MsgIssueDenom)
    - [MsgIssueDenomResponse](#petrimod.nft.MsgIssueDenomResponse)
    - [MsgMintNFT](#petrimod.nft.MsgMintNFT)
    - [MsgMintNFTResponse](#petrimod.nft.MsgMintNFTResponse)
    - [MsgTransferDenom](#petrimod.nft.MsgTransferDenom)
    - [MsgTransferDenomResponse](#petrimod.nft.MsgTransferDenomResponse)
    - [MsgTransferNFT](#petrimod.nft.MsgTransferNFT)
    - [MsgTransferNFTResponse](#petrimod.nft.MsgTransferNFTResponse)
  
    - [Msg](#petrimod.nft.Msg)
  
- [oracle/oracle.proto](#oracle/oracle.proto)
    - [Feed](#petrimod.oracle.Feed)
    - [FeedValue](#petrimod.oracle.FeedValue)
  
- [service/service.proto](#service/service.proto)
    - [CompactRequest](#petrimod.service.CompactRequest)
    - [Params](#petrimod.service.Params)
    - [Pricing](#petrimod.service.Pricing)
    - [PromotionByTime](#petrimod.service.PromotionByTime)
    - [PromotionByVolume](#petrimod.service.PromotionByVolume)
    - [Request](#petrimod.service.Request)
    - [RequestContext](#petrimod.service.RequestContext)
    - [Response](#petrimod.service.Response)
    - [ServiceBinding](#petrimod.service.ServiceBinding)
    - [ServiceDefinition](#petrimod.service.ServiceDefinition)
  
    - [RequestContextBatchState](#petrimod.service.RequestContextBatchState)
    - [RequestContextState](#petrimod.service.RequestContextState)
  
- [oracle/genesis.proto](#oracle/genesis.proto)
    - [FeedEntry](#petrimod.oracle.FeedEntry)
    - [GenesisState](#petrimod.oracle.GenesisState)
  
- [oracle/query.proto](#oracle/query.proto)
    - [FeedContext](#petrimod.oracle.FeedContext)
    - [QueryFeedRequest](#petrimod.oracle.QueryFeedRequest)
    - [QueryFeedResponse](#petrimod.oracle.QueryFeedResponse)
    - [QueryFeedValueRequest](#petrimod.oracle.QueryFeedValueRequest)
    - [QueryFeedValueResponse](#petrimod.oracle.QueryFeedValueResponse)
    - [QueryFeedsRequest](#petrimod.oracle.QueryFeedsRequest)
    - [QueryFeedsResponse](#petrimod.oracle.QueryFeedsResponse)
  
    - [Query](#petrimod.oracle.Query)
  
- [oracle/tx.proto](#oracle/tx.proto)
    - [MsgCreateFeed](#petrimod.oracle.MsgCreateFeed)
    - [MsgCreateFeedResponse](#petrimod.oracle.MsgCreateFeedResponse)
    - [MsgEditFeed](#petrimod.oracle.MsgEditFeed)
    - [MsgEditFeedResponse](#petrimod.oracle.MsgEditFeedResponse)
    - [MsgPauseFeed](#petrimod.oracle.MsgPauseFeed)
    - [MsgPauseFeedResponse](#petrimod.oracle.MsgPauseFeedResponse)
    - [MsgStartFeed](#petrimod.oracle.MsgStartFeed)
    - [MsgStartFeedResponse](#petrimod.oracle.MsgStartFeedResponse)
  
    - [Msg](#petrimod.oracle.Msg)
  
- [random/random.proto](#random/random.proto)
    - [Random](#petrimod.random.Random)
    - [Request](#petrimod.random.Request)
  
- [random/genesis.proto](#random/genesis.proto)
    - [GenesisState](#petrimod.random.GenesisState)
    - [GenesisState.PendingRandomRequestsEntry](#petrimod.random.GenesisState.PendingRandomRequestsEntry)
    - [Requests](#petrimod.random.Requests)
  
- [random/query.proto](#random/query.proto)
    - [QueryRandomRequest](#petrimod.random.QueryRandomRequest)
    - [QueryRandomRequestQueueRequest](#petrimod.random.QueryRandomRequestQueueRequest)
    - [QueryRandomRequestQueueResponse](#petrimod.random.QueryRandomRequestQueueResponse)
    - [QueryRandomResponse](#petrimod.random.QueryRandomResponse)
  
    - [Query](#petrimod.random.Query)
  
- [random/tx.proto](#random/tx.proto)
    - [MsgRequestRandom](#petrimod.random.MsgRequestRandom)
    - [MsgRequestRandomResponse](#petrimod.random.MsgRequestRandomResponse)
  
    - [Msg](#petrimod.random.Msg)
  
- [record/record.proto](#record/record.proto)
    - [Content](#petrimod.record.Content)
    - [Record](#petrimod.record.Record)
  
- [record/genesis.proto](#record/genesis.proto)
    - [GenesisState](#petrimod.record.GenesisState)
  
- [record/query.proto](#record/query.proto)
    - [QueryRecordRequest](#petrimod.record.QueryRecordRequest)
    - [QueryRecordResponse](#petrimod.record.QueryRecordResponse)
  
    - [Query](#petrimod.record.Query)
  
- [record/tx.proto](#record/tx.proto)
    - [MsgCreateRecord](#petrimod.record.MsgCreateRecord)
    - [MsgCreateRecordResponse](#petrimod.record.MsgCreateRecordResponse)
  
    - [Msg](#petrimod.record.Msg)
  
- [service/genesis.proto](#service/genesis.proto)
    - [GenesisState](#petrimod.service.GenesisState)
    - [GenesisState.RequestContextsEntry](#petrimod.service.GenesisState.RequestContextsEntry)
    - [GenesisState.WithdrawAddressesEntry](#petrimod.service.GenesisState.WithdrawAddressesEntry)
  
- [service/query.proto](#service/query.proto)
    - [QueryBindingRequest](#petrimod.service.QueryBindingRequest)
    - [QueryBindingResponse](#petrimod.service.QueryBindingResponse)
    - [QueryBindingsRequest](#petrimod.service.QueryBindingsRequest)
    - [QueryBindingsResponse](#petrimod.service.QueryBindingsResponse)
    - [QueryDefinitionRequest](#petrimod.service.QueryDefinitionRequest)
    - [QueryDefinitionResponse](#petrimod.service.QueryDefinitionResponse)
    - [QueryEarnedFeesRequest](#petrimod.service.QueryEarnedFeesRequest)
    - [QueryEarnedFeesResponse](#petrimod.service.QueryEarnedFeesResponse)
    - [QueryParamsRequest](#petrimod.service.QueryParamsRequest)
    - [QueryParamsResponse](#petrimod.service.QueryParamsResponse)
    - [QueryRequestContextRequest](#petrimod.service.QueryRequestContextRequest)
    - [QueryRequestContextResponse](#petrimod.service.QueryRequestContextResponse)
    - [QueryRequestRequest](#petrimod.service.QueryRequestRequest)
    - [QueryRequestResponse](#petrimod.service.QueryRequestResponse)
    - [QueryRequestsByReqCtxRequest](#petrimod.service.QueryRequestsByReqCtxRequest)
    - [QueryRequestsByReqCtxResponse](#petrimod.service.QueryRequestsByReqCtxResponse)
    - [QueryRequestsRequest](#petrimod.service.QueryRequestsRequest)
    - [QueryRequestsResponse](#petrimod.service.QueryRequestsResponse)
    - [QueryResponseRequest](#petrimod.service.QueryResponseRequest)
    - [QueryResponseResponse](#petrimod.service.QueryResponseResponse)
    - [QueryResponsesRequest](#petrimod.service.QueryResponsesRequest)
    - [QueryResponsesResponse](#petrimod.service.QueryResponsesResponse)
    - [QuerySchemaRequest](#petrimod.service.QuerySchemaRequest)
    - [QuerySchemaResponse](#petrimod.service.QuerySchemaResponse)
    - [QueryWithdrawAddressRequest](#petrimod.service.QueryWithdrawAddressRequest)
    - [QueryWithdrawAddressResponse](#petrimod.service.QueryWithdrawAddressResponse)
  
    - [Query](#petrimod.service.Query)
  
- [service/tx.proto](#service/tx.proto)
    - [MsgBindService](#petrimod.service.MsgBindService)
    - [MsgBindServiceResponse](#petrimod.service.MsgBindServiceResponse)
    - [MsgCallService](#petrimod.service.MsgCallService)
    - [MsgCallServiceResponse](#petrimod.service.MsgCallServiceResponse)
    - [MsgDefineService](#petrimod.service.MsgDefineService)
    - [MsgDefineServiceResponse](#petrimod.service.MsgDefineServiceResponse)
    - [MsgDisableServiceBinding](#petrimod.service.MsgDisableServiceBinding)
    - [MsgDisableServiceBindingResponse](#petrimod.service.MsgDisableServiceBindingResponse)
    - [MsgEnableServiceBinding](#petrimod.service.MsgEnableServiceBinding)
    - [MsgEnableServiceBindingResponse](#petrimod.service.MsgEnableServiceBindingResponse)
    - [MsgKillRequestContext](#petrimod.service.MsgKillRequestContext)
    - [MsgKillRequestContextResponse](#petrimod.service.MsgKillRequestContextResponse)
    - [MsgPauseRequestContext](#petrimod.service.MsgPauseRequestContext)
    - [MsgPauseRequestContextResponse](#petrimod.service.MsgPauseRequestContextResponse)
    - [MsgRefundServiceDeposit](#petrimod.service.MsgRefundServiceDeposit)
    - [MsgRefundServiceDepositResponse](#petrimod.service.MsgRefundServiceDepositResponse)
    - [MsgRespondService](#petrimod.service.MsgRespondService)
    - [MsgRespondServiceResponse](#petrimod.service.MsgRespondServiceResponse)
    - [MsgSetWithdrawAddress](#petrimod.service.MsgSetWithdrawAddress)
    - [MsgSetWithdrawAddressResponse](#petrimod.service.MsgSetWithdrawAddressResponse)
    - [MsgStartRequestContext](#petrimod.service.MsgStartRequestContext)
    - [MsgStartRequestContextResponse](#petrimod.service.MsgStartRequestContextResponse)
    - [MsgUpdateRequestContext](#petrimod.service.MsgUpdateRequestContext)
    - [MsgUpdateRequestContextResponse](#petrimod.service.MsgUpdateRequestContextResponse)
    - [MsgUpdateServiceBinding](#petrimod.service.MsgUpdateServiceBinding)
    - [MsgUpdateServiceBindingResponse](#petrimod.service.MsgUpdateServiceBindingResponse)
    - [MsgWithdrawEarnedFees](#petrimod.service.MsgWithdrawEarnedFees)
    - [MsgWithdrawEarnedFeesResponse](#petrimod.service.MsgWithdrawEarnedFeesResponse)
  
    - [Msg](#petrimod.service.Msg)
  
- [token/token.proto](#token/token.proto)
    - [Params](#petrimod.token.Params)
    - [Token](#petrimod.token.Token)
  
- [token/genesis.proto](#token/genesis.proto)
    - [GenesisState](#petrimod.token.GenesisState)
  
- [token/query.proto](#token/query.proto)
    - [QueryFeesRequest](#petrimod.token.QueryFeesRequest)
    - [QueryFeesResponse](#petrimod.token.QueryFeesResponse)
    - [QueryParamsRequest](#petrimod.token.QueryParamsRequest)
    - [QueryParamsResponse](#petrimod.token.QueryParamsResponse)
    - [QueryTokenRequest](#petrimod.token.QueryTokenRequest)
    - [QueryTokenResponse](#petrimod.token.QueryTokenResponse)
    - [QueryTokensRequest](#petrimod.token.QueryTokensRequest)
    - [QueryTokensResponse](#petrimod.token.QueryTokensResponse)
    - [QueryTotalBurnRequest](#petrimod.token.QueryTotalBurnRequest)
    - [QueryTotalBurnResponse](#petrimod.token.QueryTotalBurnResponse)
  
    - [Query](#petrimod.token.Query)
  
- [token/tx.proto](#token/tx.proto)
    - [MsgBurnToken](#petrimod.token.MsgBurnToken)
    - [MsgBurnTokenResponse](#petrimod.token.MsgBurnTokenResponse)
    - [MsgEditToken](#petrimod.token.MsgEditToken)
    - [MsgEditTokenResponse](#petrimod.token.MsgEditTokenResponse)
    - [MsgIssueToken](#petrimod.token.MsgIssueToken)
    - [MsgIssueTokenResponse](#petrimod.token.MsgIssueTokenResponse)
    - [MsgMintToken](#petrimod.token.MsgMintToken)
    - [MsgMintTokenResponse](#petrimod.token.MsgMintTokenResponse)
    - [MsgTransferTokenOwner](#petrimod.token.MsgTransferTokenOwner)
    - [MsgTransferTokenOwnerResponse](#petrimod.token.MsgTransferTokenOwnerResponse)
  
    - [Msg](#petrimod.token.Msg)
...
<a name="petrimod.coinswap.Input"></a>
...
<a name="petrimod.coinswap.Output"></a>
...
<a name="petrimod.coinswap.Params"></a>
...
<a name="petrimod.coinswap.Pool"></a>
...
<a name="petrimod.coinswap.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#petrimod.coinswap.Params) |  |  |
| `standard_denom` | [string](#string) |  |  |
| `pool` | [Pool](#petrimod.coinswap.Pool) | repeated |  |
...
<a name="petrimod.coinswap.PoolInfo"></a>
...
<a name="petrimod.coinswap.QueryLiquidityPoolRequest"></a>
...
<a name="petrimod.coinswap.QueryLiquidityPoolResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `pool` | [PoolInfo](#petrimod.coinswap.PoolInfo) |  |  |
...
<a name="petrimod.coinswap.QueryLiquidityPoolsRequest"></a>
...
<a name="petrimod.coinswap.QueryLiquidityPoolsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `pools` | [PoolInfo](#petrimod.coinswap.PoolInfo) | repeated |  |
...
<a name="petrimod.coinswap.Query"></a>
...
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `LiquidityPool` | [QueryLiquidityPoolRequest](#petrimod.coinswap.QueryLiquidityPoolRequest) | [QueryLiquidityPoolResponse](#petrimod.coinswap.QueryLiquidityPoolResponse) | LiquidityPool returns the liquidity pool for the provided lpt_denom | GET|/petrimod/coinswap/pools/{lpt_denom}|
| `LiquidityPools` | [QueryLiquidityPoolsRequest](#petrimod.coinswap.QueryLiquidityPoolsRequest) | [QueryLiquidityPoolsResponse](#petrimod.coinswap.QueryLiquidityPoolsResponse) | LiquidityPools returns all the liquidity pools available | GET|/petrimod/coinswap/pools|
...
<a name="petrimod.coinswap.MsgAddLiquidity"></a>
...
<a name="petrimod.coinswap.MsgAddLiquidityResponse"></a>
...
<a name="petrimod.coinswap.MsgRemoveLiquidity"></a>
...
<a name="petrimod.coinswap.MsgRemoveLiquidityResponse"></a>
...
<a name="petrimod.coinswap.MsgSwapCoinResponse"></a>
...
<a name="petrimod.coinswap.MsgSwapOrder"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `input` | [Input](#petrimod.coinswap.Input) |  |  |
| `output` | [Output](#petrimod.coinswap.Output) |  |  |
| `deadline` | [int64](#int64) |  |  |
...
<a name="petrimod.coinswap.Msg"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `AddLiquidity` | [MsgAddLiquidity](#petrimod.coinswap.MsgAddLiquidity) | [MsgAddLiquidityResponse](#petrimod.coinswap.MsgAddLiquidityResponse) | AddLiquidity defines a method for depositing some tokens to the liquidity pool | |
| `RemoveLiquidity` | [MsgRemoveLiquidity](#petrimod.coinswap.MsgRemoveLiquidity) | [MsgRemoveLiquidityResponse](#petrimod.coinswap.MsgRemoveLiquidityResponse) | RemoveLiquidity defines a method for withdraw some tokens from the liquidity pool | |
| `SwapCoin` | [MsgSwapOrder](#petrimod.coinswap.MsgSwapOrder) | [MsgSwapCoinResponse](#petrimod.coinswap.MsgSwapCoinResponse) | SwapCoin defines a method for swapping a token with the other token from the liquidity pool | |
...
<a name="petrimod.farm.FarmInfo"></a>
...
<a name="petrimod.farm.FarmPool"></a>
...
| `rules` | [RewardRule](#petrimod.farm.RewardRule) | repeated |  |
...
<a name="petrimod.farm.RewardRule"></a>
...
<a name="petrimod.farm.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#petrimod.farm.Params) |  |  |
| `pools` | [FarmPool](#petrimod.farm.FarmPool) | repeated |  |
| `farm_infos` | [FarmInfo](#petrimod.farm.FarmInfo) | repeated |  |
...
<a name="petrimod.farm.FarmPoolEntry"></a>
...
<a name="petrimod.farm.LockedInfo"></a>
...
<a name="petrimod.farm.QueryFarmPoolRequest"></a>
...
<a name="petrimod.farm.QueryFarmPoolResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `pool` | [FarmPoolEntry](#petrimod.farm.FarmPoolEntry) |  |  |
...
<a name="petrimod.farm.QueryFarmPoolsRequest"></a>
...
<a name="petrimod.farm.QueryFarmPoolsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `pools` | [FarmPoolEntry](#petrimod.farm.FarmPoolEntry) | repeated |  |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  |  |
...
<a name="petrimod.farm.QueryFarmerRequest"></a>
...
<a name="petrimod.farm.QueryFarmerResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `list` | [LockedInfo](#petrimod.farm.LockedInfo) | repeated |  |
| `height` | [int64](#int64) |  |  |
...
<a name="petrimod.farm.QueryParamsRequest"></a>
...
<a name="petrimod.farm.QueryParamsResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `FarmPools` | [QueryFarmPoolsRequest](#petrimod.farm.QueryFarmPoolsRequest) | [QueryFarmPoolsResponse](#petrimod.farm.QueryFarmPoolsResponse) |  | GET|/petrimod/farm/pools|
| `FarmPool` | [QueryFarmPoolRequest](#petrimod.farm.QueryFarmPoolRequest) | [QueryFarmPoolResponse](#petrimod.farm.QueryFarmPoolResponse) |  | GET|/petrimod/farm/pool/{name}|
| `Farmer` | [QueryFarmerRequest](#petrimod.farm.QueryFarmerRequest) | [QueryFarmerResponse](#petrimod.farm.QueryFarmerResponse) |  | GET|/petrimod/farm/farmers/{farmer}|
| `Params` | [QueryParamsRequest](#petrimod.farm.QueryParamsRequest) | [QueryParamsResponse](#petrimod.farm.QueryParamsResponse) | Params queries the htlc parameters | GET|/petrimod/farm/params|
...
<a name="petrimod.farm.MsgAdjustPool"></a>
...
<a name="petrimod.farm.MsgAdjustPoolResponse"></a>
...
<a name="petrimod.farm.MsgCreatePool"></a>
...
<a name="petrimod.farm.MsgCreatePoolResponse"></a>
...
<a name="petrimod.farm.MsgDestroyPool"></a>
...
<a name="petrimod.farm.MsgDestroyPoolResponse"></a>
...
<a name="petrimod.farm.MsgHarvest"></a>
...
<a name="petrimod.farm.MsgHarvestResponse"></a>
...
<a name="petrimod.farm.MsgStake"></a>
...
<a name="petrimod.farm.MsgStakeResponse"></a>
...
<a name="petrimod.farm.MsgUnstake"></a>
...
<a name="petrimod.farm.MsgUnstakeResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `CreatePool` | [MsgCreatePool](#petrimod.farm.MsgCreatePool) | [MsgCreatePoolResponse](#petrimod.farm.MsgCreatePoolResponse) | CreatePool defines a method for creating a new farm pool | |
| `DestroyPool` | [MsgDestroyPool](#petrimod.farm.MsgDestroyPool) | [MsgDestroyPoolResponse](#petrimod.farm.MsgDestroyPoolResponse) | DestroyPool defines a method for destroying a existed farm pool | |
| `AdjustPool` | [MsgAdjustPool](#petrimod.farm.MsgAdjustPool) | [MsgAdjustPoolResponse](#petrimod.farm.MsgAdjustPoolResponse) | AdjustPool defines a method for adjusting the farm pool params | |
| `Stake` | [MsgStake](#petrimod.farm.MsgStake) | [MsgStakeResponse](#petrimod.farm.MsgStakeResponse) | Stake defines a method for staking some lp token to a farm pool | |
| `Unstake` | [MsgUnstake](#petrimod.farm.MsgUnstake) | [MsgUnstakeResponse](#petrimod.farm.MsgUnstakeResponse) | Unstake defines a method for unstaking some lp token from a farm pool and withdraw some reward | |
| `Harvest` | [MsgHarvest](#petrimod.farm.MsgHarvest) | [MsgHarvestResponse](#petrimod.farm.MsgHarvestResponse) | Harvest defines a method withdraw some reward from a farm pool | |
...
<a name="petrimod.htlc.AssetParam"></a>
...
| `supply_limit` | [SupplyLimit](#petrimod.htlc.SupplyLimit) |  | asset supply limit |
...
<a name="petrimod.htlc.AssetSupply"></a>
...
| `state` | [HTLCState](#petrimod.htlc.HTLCState) |  |  |
| `closed_block` | [uint64](#uint64) |  |  |
| `transfer` | [bool](#bool) |  |  |
| `direction` | [SwapDirection](#petrimod.htlc.SwapDirection) |  |  |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `asset_params` | [AssetParam](#petrimod.htlc.AssetParam) | repeated |  |
...
<a name="petrimod.htlc.SupplyLimit"></a>
...
<a name="petrimod.htlc.HTLCState"></a>
...
<a name="petrimod.htlc.SwapDirection"></a>
...
<a name="petrimod.htlc.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#petrimod.htlc.Params) |  |  |
| `htlcs` | [HTLC](#petrimod.htlc.HTLC) | repeated |  |
| `supplies` | [AssetSupply](#petrimod.htlc.AssetSupply) | repeated |  |
...
<a name="petrimod.htlc.QueryAssetSuppliesRequest"></a>
...
<a name="petrimod.htlc.QueryAssetSuppliesResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `asset_supplies` | [AssetSupply](#petrimod.htlc.AssetSupply) | repeated |  |
...
<a name="petrimod.htlc.QueryAssetSupplyRequest"></a>
...
<a name="petrimod.htlc.QueryAssetSupplyResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `asset_supply` | [AssetSupply](#petrimod.htlc.AssetSupply) |  |  |
...
<a name="petrimod.htlc.QueryHTLCRequest"></a>
...
<a name="petrimod.htlc.QueryHTLCResponse"></a>
...
<a name="petrimod.htlc.QueryParamsRequest"></a>
...
<a name="petrimod.htlc.QueryParamsResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `HTLC` | [QueryHTLCRequest](#petrimod.htlc.QueryHTLCRequest) | [QueryHTLCResponse](#petrimod.htlc.QueryHTLCResponse) | HTLC queries the HTLC by the specified hash lock | GET|/petrimod/htlc/htlcs/{id}|
| `AssetSupply` | [QueryAssetSupplyRequest](#petrimod.htlc.QueryAssetSupplyRequest) | [QueryAssetSupplyResponse](#petrimod.htlc.QueryAssetSupplyResponse) | AssetSupply queries the supply of an asset | GET|/petrimod/htlc/supplies/{denom}|
| `AssetSupplies` | [QueryAssetSuppliesRequest](#petrimod.htlc.QueryAssetSuppliesRequest) | [QueryAssetSuppliesResponse](#petrimod.htlc.QueryAssetSuppliesResponse) | AssetSupplies queries the supplies of all assets | GET|/petrimod/htlc/supplies|
| `Params` | [QueryParamsRequest](#petrimod.htlc.QueryParamsRequest) | [QueryParamsResponse](#petrimod.htlc.QueryParamsResponse) | Params queries the htlc parameters | GET|/petrimod/htlc/params|
...
<a name="petrimod.htlc.MsgClaimHTLC"></a>
...
<a name="petrimod.htlc.MsgClaimHTLCResponse"></a>
...
<a name="petrimod.htlc.MsgCreateHTLC"></a>
...
<a name="petrimod.htlc.MsgCreateHTLCResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `CreateHTLC` | [MsgCreateHTLC](#petrimod.htlc.MsgCreateHTLC) | [MsgCreateHTLCResponse](#petrimod.htlc.MsgCreateHTLCResponse) | CreateHTLC defines a method for creating a HTLC | |
| `ClaimHTLC` | [MsgClaimHTLC](#petrimod.htlc.MsgClaimHTLC) | [MsgClaimHTLCResponse](#petrimod.htlc.MsgClaimHTLCResponse) | ClaimHTLC defines a method for claiming a HTLC | |
...
<a name="petrimod.nft.Collection"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `denom` | [Denom](#petrimod.nft.Denom) |  |  |
| `nfts` | [BaseNFT](#petrimod.nft.BaseNFT) | repeated |  |
...
<a name="petrimod.nft.IDCollection"></a>
...
| ----- | ---- | ----- | ----------- |
| `address` | [string](#string) |  |  |
| `id_collections` | [IDCollection](#petrimod.nft.IDCollection) | repeated |  |
...
<a name="petrimod.nft.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `collections` | [Collection](#petrimod.nft.Collection) | repeated |  |
...
<a name="petrimod.nft.QueryCollectionRequest"></a>
...
<a name="petrimod.nft.QueryCollectionResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `collection` | [Collection](#petrimod.nft.Collection) |  |  |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  |  |
...
<a name="petrimod.nft.QueryDenomRequest"></a>
...
<a name="petrimod.nft.QueryDenomResponse"></a>
...
<a name="petrimod.nft.QueryDenomsRequest"></a>
...
<a name="petrimod.nft.QueryDenomsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `denoms` | [Denom](#petrimod.nft.Denom) | repeated |  |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  |  |
...
<a name="petrimod.nft.QueryNFTRequest"></a>
...
<a name="petrimod.nft.QueryNFTResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `nft` | [BaseNFT](#petrimod.nft.BaseNFT) |  |  |
...
<a name="petrimod.nft.QueryOwnerRequest"></a>
...
<a name="petrimod.nft.QueryOwnerResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `owner` | [Owner](#petrimod.nft.Owner) |  |  |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  |  |
...
<a name="petrimod.nft.QuerySupplyRequest"></a>
...
<a name="petrimod.nft.QuerySupplyResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `Supply` | [QuerySupplyRequest](#petrimod.nft.QuerySupplyRequest) | [QuerySupplyResponse](#petrimod.nft.QuerySupplyResponse) | Supply queries the total supply of a given denom or owner | GET|/petrimod/nft/collections/{denom_id}/supply|
| `Owner` | [QueryOwnerRequest](#petrimod.nft.QueryOwnerRequest) | [QueryOwnerResponse](#petrimod.nft.QueryOwnerResponse) | Owner queries the NFTs of the specified owner | GET|/petrimod/nft/nfts|
| `Collection` | [QueryCollectionRequest](#petrimod.nft.QueryCollectionRequest) | [QueryCollectionResponse](#petrimod.nft.QueryCollectionResponse) | Collection queries the NFTs of the specified denom | GET|/petrimod/nft/collections/{denom_id}|
| `Denom` | [QueryDenomRequest](#petrimod.nft.QueryDenomRequest) | [QueryDenomResponse](#petrimod.nft.QueryDenomResponse) | Denom queries the definition of a given denom | GET|/petrimod/nft/denoms/{denom_id}|
| `Denoms` | [QueryDenomsRequest](#petrimod.nft.QueryDenomsRequest) | [QueryDenomsResponse](#petrimod.nft.QueryDenomsResponse) | Denoms queries all the denoms | GET|/petrimod/nft/denoms|
| `NFT` | [QueryNFTRequest](#petrimod.nft.QueryNFTRequest) | [QueryNFTResponse](#petrimod.nft.QueryNFTResponse) | NFT queries the NFT for the given denom and token ID | GET|/petrimod/nft/nfts/{denom_id}/{token_id}|
...
<a name="petrimod.nft.MsgBurnNFT"></a>
...
<a name="petrimod.nft.MsgBurnNFTResponse"></a>
...
<a name="petrimod.nft.MsgEditNFT"></a>
...
<a name="petrimod.nft.MsgEditNFTResponse"></a>
...
<a name="petrimod.nft.MsgIssueDenom"></a>
...
<a name="petrimod.nft.MsgIssueDenomResponse"></a>
...
<a name="petrimod.nft.MsgMintNFT"></a>
...
<a name="petrimod.nft.MsgMintNFTResponse"></a>
...
<a name="petrimod.nft.MsgTransferDenom"></a>
...
<a name="petrimod.nft.MsgTransferDenomResponse"></a>
...
<a name="petrimod.nft.MsgTransferNFT"></a>
...
<a name="petrimod.nft.MsgTransferNFTResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `IssueDenom` | [MsgIssueDenom](#petrimod.nft.MsgIssueDenom) | [MsgIssueDenomResponse](#petrimod.nft.MsgIssueDenomResponse) | IssueDenom defines a method for issue a denom. | |
| `MintNFT` | [MsgMintNFT](#petrimod.nft.MsgMintNFT) | [MsgMintNFTResponse](#petrimod.nft.MsgMintNFTResponse) | MintNFT defines a method for mint a new nft | |
| `EditNFT` | [MsgEditNFT](#petrimod.nft.MsgEditNFT) | [MsgEditNFTResponse](#petrimod.nft.MsgEditNFTResponse) | RefundHTLC defines a method for editing a nft. | |
| `TransferNFT` | [MsgTransferNFT](#petrimod.nft.MsgTransferNFT) | [MsgTransferNFTResponse](#petrimod.nft.MsgTransferNFTResponse) | TransferNFT defines a method for transferring a nft. | |
| `BurnNFT` | [MsgBurnNFT](#petrimod.nft.MsgBurnNFT) | [MsgBurnNFTResponse](#petrimod.nft.MsgBurnNFTResponse) | BurnNFT defines a method for burning a nft. | |
| `TransferDenom` | [MsgTransferDenom](#petrimod.nft.MsgTransferDenom) | [MsgTransferDenomResponse](#petrimod.nft.MsgTransferDenomResponse) | TransferDenom defines a method for transferring a denom. | |
...
<a name="petrimod.oracle.FeedValue"></a>
...
<a name="petrimod.service.CompactRequest"></a>
...
<a name="petrimod.service.Params"></a>
...
<a name="petrimod.service.Pricing"></a>
...
| `promotions_by_time` | [PromotionByTime](#petrimod.service.PromotionByTime) | repeated |  |
| `promotions_by_volume` | [PromotionByVolume](#petrimod.service.PromotionByVolume) | repeated |  |
...
<a name="petrimod.service.PromotionByTime"></a>
...
<a name="petrimod.service.PromotionByVolume"></a>
...
<a name="petrimod.service.Request"></a>
...
<a name="petrimod.service.RequestContext"></a>
...
| `batch_state` | [RequestContextBatchState](#petrimod.service.RequestContextBatchState) |  |  |
| `state` | [RequestContextState](#petrimod.service.RequestContextState) |  |  |
...
<a name="petrimod.service.Response"></a>
...
<a name="petrimod.service.ServiceBinding"></a>
...
<a name="petrimod.service.ServiceDefinition"></a>
...
<a name="petrimod.service.RequestContextBatchState"></a>
...
<a name="petrimod.service.RequestContextState"></a>
...
<a name="petrimod.oracle.FeedEntry"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `feed` | [Feed](#petrimod.oracle.Feed) |  |  |
| `state` | [petrimod.service.RequestContextState](#petrimod.service.RequestContextState) |  |  |
| `values` | [FeedValue](#petrimod.oracle.FeedValue) | repeated |  |
...
<a name="petrimod.oracle.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `entries` | [FeedEntry](#petrimod.oracle.FeedEntry) | repeated |  |
...
<a name="petrimod.oracle.FeedContext"></a>
...
<a name="petrimod.oracle.QueryFeedRequest"></a>
...
<a name="petrimod.oracle.QueryFeedResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `feed` | [FeedContext](#petrimod.oracle.FeedContext) |  |  |
...
<a name="petrimod.oracle.QueryFeedValueRequest"></a>
...
<a name="petrimod.oracle.QueryFeedValueResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `feed_values` | [FeedValue](#petrimod.oracle.FeedValue) | repeated |  |
...
<a name="petrimod.oracle.QueryFeedsRequest"></a>
...
<a name="petrimod.oracle.QueryFeedsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `feeds` | [FeedContext](#petrimod.oracle.FeedContext) | repeated |  |
...
<a name="petrimod.oracle.Query"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `Feed` | [QueryFeedRequest](#petrimod.oracle.QueryFeedRequest) | [QueryFeedResponse](#petrimod.oracle.QueryFeedResponse) | Feed queries the feed | GET|/petrimod/oracle/feeds/{feed_name}|
| `Feeds` | [QueryFeedsRequest](#petrimod.oracle.QueryFeedsRequest) | [QueryFeedsResponse](#petrimod.oracle.QueryFeedsResponse) | Feeds queries the feed list | GET|/petrimod/oracle/feeds|
| `FeedValue` | [QueryFeedValueRequest](#petrimod.oracle.QueryFeedValueRequest) | [QueryFeedValueResponse](#petrimod.oracle.QueryFeedValueResponse) | FeedValue queries the feed value | GET|/petrimod/oracle/feeds/{feed_name}/values|
...
<a name="petrimod.oracle.MsgCreateFeed"></a>
...
<a name="petrimod.oracle.MsgCreateFeedResponse"></a>
...
<a name="petrimod.oracle.MsgEditFeed"></a>
...
<a name="petrimod.oracle.MsgEditFeedResponse"></a>
...
<a name="petrimod.oracle.MsgPauseFeed"></a>
...
<a name="petrimod.oracle.MsgPauseFeedResponse"></a>
...
<a name="petrimod.oracle.MsgStartFeed"></a>
...
<a name="petrimod.oracle.MsgStartFeedResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `CreateFeed` | [MsgCreateFeed](#petrimod.oracle.MsgCreateFeed) | [MsgCreateFeedResponse](#petrimod.oracle.MsgCreateFeedResponse) | CreateFeed defines a method for creating a new feed | |
| `EditFeed` | [MsgEditFeed](#petrimod.oracle.MsgEditFeed) | [MsgEditFeedResponse](#petrimod.oracle.MsgEditFeedResponse) | EditFeed defines a method for editing a feed | |
| `StartFeed` | [MsgStartFeed](#petrimod.oracle.MsgStartFeed) | [MsgStartFeedResponse](#petrimod.oracle.MsgStartFeedResponse) | StartFeed defines a method for starting a feed | |
| `PauseFeed` | [MsgPauseFeed](#petrimod.oracle.MsgPauseFeed) | [MsgPauseFeedResponse](#petrimod.oracle.MsgPauseFeedResponse) | PauseFeed defines a method for pausing a feed | |
...
<a name="petrimod.random.Random"></a>
...
<a name="petrimod.random.Request"></a>
...
<a name="petrimod.random.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `pending_random_requests` | [GenesisState.PendingRandomRequestsEntry](#petrimod.random.GenesisState.PendingRandomRequestsEntry) | repeated |  |
...
<a name="petrimod.random.GenesisState.PendingRandomRequestsEntry"></a>
...
| ----- | ---- | ----- | ----------- |
| `key` | [string](#string) |  |  |
| `value` | [Requests](#petrimod.random.Requests) |  |  |
...
<a name="petrimod.random.Requests"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `requests` | [Request](#petrimod.random.Request) | repeated |  |
...
<a name="petrimod.random.QueryRandomRequest"></a>
...
<a name="petrimod.random.QueryRandomRequestQueueRequest"></a>
...
<a name="petrimod.random.QueryRandomRequestQueueResponse"></a>
...
<a name="petrimod.random.QueryRandomResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `random` | [Random](#petrimod.random.Random) |  |  |
...
<a name="petrimod.random.Query"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `Random` | [QueryRandomRequest](#petrimod.random.QueryRandomRequest) | [QueryRandomResponse](#petrimod.random.QueryRandomResponse) | Random queries the random result | GET|/petrimod/random/randoms/{req_id}|
| `RandomRequestQueue` | [QueryRandomRequestQueueRequest](#petrimod.random.QueryRandomRequestQueueRequest) | [QueryRandomRequestQueueResponse](#petrimod.random.QueryRandomRequestQueueResponse) | RandomRequestQueue queries the random request queue | GET|/petrimod/random/queue|
...
<a name="petrimod.random.MsgRequestRandom"></a>
...
<a name="petrimod.random.MsgRequestRandomResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `RequestRandom` | [MsgRequestRandom](#petrimod.random.MsgRequestRandom) | [MsgRequestRandomResponse](#petrimod.random.MsgRequestRandomResponse) | RequestRandom defines a method for requesting a new random number | |
...
<a name="petrimod.record.Content"></a>
...
<a name="petrimod.record.Record"></a>
...
| ----- | ---- | ----- | ----------- |
| `tx_hash` | [string](#string) |  |  |
| `contents` | [Content](#petrimod.record.Content) | repeated |  |
| `creator` | [string](#string) |  |  |
...
<a name="petrimod.record.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `records` | [Record](#petrimod.record.Record) | repeated |  |
...
<a name="petrimod.record.QueryRecordRequest"></a>
...
<a name="petrimod.record.QueryRecordResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `record` | [Record](#petrimod.record.Record) |  |  |
...
<a name="petrimod.record.Query"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `Record` | [QueryRecordRequest](#petrimod.record.QueryRecordRequest) | [QueryRecordResponse](#petrimod.record.QueryRecordResponse) | Record queries the record by the given record ID | GET|/petrimod/record/records/{record_id}|
...
<a name="petrimod.record.MsgCreateRecord"></a>
...
<a name="petrimod.record.MsgCreateRecordResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `CreateRecord` | [MsgCreateRecord](#petrimod.record.MsgCreateRecord) | [MsgCreateRecordResponse](#petrimod.record.MsgCreateRecordResponse) | CreateRecord defines a method for creating a new record | |
...
<a name="petrimod.service.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#petrimod.service.Params) |  |  |
| `definitions` | [ServiceDefinition](#petrimod.service.ServiceDefinition) | repeated |  |
| `bindings` | [ServiceBinding](#petrimod.service.ServiceBinding) | repeated |  |
| `withdraw_addresses` | [GenesisState.WithdrawAddressesEntry](#petrimod.service.GenesisState.WithdrawAddressesEntry) | repeated |  |
| `request_contexts` | [GenesisState.RequestContextsEntry](#petrimod.service.GenesisState.RequestContextsEntry) | repeated |  |
...
<a name="petrimod.service.GenesisState.RequestContextsEntry"></a>
...
| ----- | ---- | ----- | ----------- |
| `key` | [string](#string) |  |  |
| `value` | [RequestContext](#petrimod.service.RequestContext) |  |  |
...
<a name="petrimod.service.GenesisState.WithdrawAddressesEntry"></a>
...
<a name="petrimod.service.QueryBindingRequest"></a>
...
<a name="petrimod.service.QueryBindingResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `service_binding` | [ServiceBinding](#petrimod.service.ServiceBinding) |  |  |
...
<a name="petrimod.service.QueryBindingsRequest"></a>
...
<a name="petrimod.service.QueryBindingsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `service_bindings` | [ServiceBinding](#petrimod.service.ServiceBinding) | repeated |  |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  |  |
...
<a name="petrimod.service.QueryDefinitionRequest"></a>
...
<a name="petrimod.service.QueryDefinitionResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `service_definition` | [ServiceDefinition](#petrimod.service.ServiceDefinition) |  |  |
...
<a name="petrimod.service.QueryEarnedFeesRequest"></a>
...
<a name="petrimod.service.QueryEarnedFeesResponse"></a>
...
<a name="petrimod.service.QueryParamsRequest"></a>
...
<a name="petrimod.service.QueryParamsResponse"></a>
...
<a name="petrimod.service.QueryRequestContextRequest"></a>
...
<a name="petrimod.service.QueryRequestContextResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `request_context` | [RequestContext](#petrimod.service.RequestContext) |  |  |
...
<a name="petrimod.service.QueryRequestRequest"></a>
...
<a name="petrimod.service.QueryRequestResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `request` | [Request](#petrimod.service.Request) |  |  |
...
<a name="petrimod.service.QueryRequestsByReqCtxRequest"></a>
...
<a name="petrimod.service.QueryRequestsByReqCtxResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `requests` | [Request](#petrimod.service.Request) | repeated |  |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  |  |
...
<a name="petrimod.service.QueryRequestsRequest"></a>
...
<a name="petrimod.service.QueryRequestsResponse"></a>
...
<a name="petrimod.service.QueryResponseRequest"></a>
...
<a name="petrimod.service.QueryResponseResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `response` | [Response](#petrimod.service.Response) |  |  |
...
<a name="petrimod.service.QueryResponsesRequest"></a>
...
<a name="petrimod.service.QueryResponsesResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `responses` | [Response](#petrimod.service.Response) | repeated |  |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  |  |
...
<a name="petrimod.service.QuerySchemaRequest"></a>
...
<a name="petrimod.service.QuerySchemaResponse"></a>
...
<a name="petrimod.service.QueryWithdrawAddressRequest"></a>
...
<a name="petrimod.service.QueryWithdrawAddressResponse"></a>
...
<a name="petrimod.service.Query"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `Definition` | [QueryDefinitionRequest](#petrimod.service.QueryDefinitionRequest) | [QueryDefinitionResponse](#petrimod.service.QueryDefinitionResponse) | Definition returns service definition | GET|/petrimod/service/definitions/{service_name}|
| `Binding` | [QueryBindingRequest](#petrimod.service.QueryBindingRequest) | [QueryBindingResponse](#petrimod.service.QueryBindingResponse) | Binding returns service Binding with service name and provider | GET|/petrimod/service/bindings/{service_name}/{provider}|
| `Bindings` | [QueryBindingsRequest](#petrimod.service.QueryBindingsRequest) | [QueryBindingsResponse](#petrimod.service.QueryBindingsResponse) | Bindings returns all service Bindings with service name and owner | GET|/petrimod/service/bindings/{service_name}|
| `WithdrawAddress` | [QueryWithdrawAddressRequest](#petrimod.service.QueryWithdrawAddressRequest) | [QueryWithdrawAddressResponse](#petrimod.service.QueryWithdrawAddressResponse) | WithdrawAddress returns the withdraw address of the binding owner | GET|/petrimod/service/owners/{owner}/withdraw-address|
| `RequestContext` | [QueryRequestContextRequest](#petrimod.service.QueryRequestContextRequest) | [QueryRequestContextResponse](#petrimod.service.QueryRequestContextResponse) | RequestContext returns the request context | GET|/petrimod/service/contexts/{request_context_id}|
| `Request` | [QueryRequestRequest](#petrimod.service.QueryRequestRequest) | [QueryRequestResponse](#petrimod.service.QueryRequestResponse) | Request returns the request | GET|/petrimod/service/requests/{request_id}|
| `Requests` | [QueryRequestsRequest](#petrimod.service.QueryRequestsRequest) | [QueryRequestsResponse](#petrimod.service.QueryRequestsResponse) | Request returns all requests of one service with provider | GET|/petrimod/service/requests/{service_name}/{provider}|
| `RequestsByReqCtx` | [QueryRequestsByReqCtxRequest](#petrimod.service.QueryRequestsByReqCtxRequest) | [QueryRequestsByReqCtxResponse](#petrimod.service.QueryRequestsByReqCtxResponse) | RequestsByReqCtx returns all requests of one service call batch | GET|/petrimod/service/requests/{request_context_id}/{batch_counter}|
| `Response` | [QueryResponseRequest](#petrimod.service.QueryResponseRequest) | [QueryResponseResponse](#petrimod.service.QueryResponseResponse) | Response returns the response of request | GET|/petrimod/service/responses/{request_id}|
| `Responses` | [QueryResponsesRequest](#petrimod.service.QueryResponsesRequest) | [QueryResponsesResponse](#petrimod.service.QueryResponsesResponse) | Responses returns all responses of one service call batch | GET|/petrimod/service/responses/{request_context_id}/{batch_counter}|
| `EarnedFees` | [QueryEarnedFeesRequest](#petrimod.service.QueryEarnedFeesRequest) | [QueryEarnedFeesResponse](#petrimod.service.QueryEarnedFeesResponse) | EarnedFees returns the earned service fee of one provider | GET|/petrimod/service/fees/{provider}|
| `Schema` | [QuerySchemaRequest](#petrimod.service.QuerySchemaRequest) | [QuerySchemaResponse](#petrimod.service.QuerySchemaResponse) | Schema returns the schema | GET|/petrimod/service/schemas/{schema_name}|
| `Params` | [QueryParamsRequest](#petrimod.service.QueryParamsRequest) | [QueryParamsResponse](#petrimod.service.QueryParamsResponse) | Params queries the service parameters | GET|/petrimod/service/params|
...
<a name="petrimod.service.MsgBindService"></a>
...
<a name="petrimod.service.MsgBindServiceResponse"></a>
...
<a name="petrimod.service.MsgCallService"></a>
...
<a name="petrimod.service.MsgCallServiceResponse"></a>
...
<a name="petrimod.service.MsgDefineService"></a>
...
<a name="petrimod.service.MsgDefineServiceResponse"></a>
...
<a name="petrimod.service.MsgDisableServiceBinding"></a>
...
<a name="petrimod.service.MsgDisableServiceBindingResponse"></a>
...
<a name="petrimod.service.MsgEnableServiceBinding"></a>
...
<a name="petrimod.service.MsgEnableServiceBindingResponse"></a>
...
<a name="petrimod.service.MsgKillRequestContext"></a>
...
<a name="petrimod.service.MsgKillRequestContextResponse"></a>
...
<a name="petrimod.service.MsgPauseRequestContext"></a>
...
<a name="petrimod.service.MsgPauseRequestContextResponse"></a>
...
<a name="petrimod.service.MsgRefundServiceDeposit"></a>
...
<a name="petrimod.service.MsgRefundServiceDepositResponse"></a>
...
<a name="petrimod.service.MsgRespondService"></a>
...
<a name="petrimod.service.MsgRespondServiceResponse"></a>
...
<a name="petrimod.service.MsgSetWithdrawAddress"></a>
...
<a name="petrimod.service.MsgSetWithdrawAddressResponse"></a>
...
<a name="petrimod.service.MsgStartRequestContext"></a>
...
<a name="petrimod.service.MsgStartRequestContextResponse"></a>
...
<a name="petrimod.service.MsgUpdateRequestContext"></a>
...
<a name="petrimod.service.MsgUpdateRequestContextResponse"></a>
...
<a name="petrimod.service.MsgUpdateServiceBinding"></a>
...
<a name="petrimod.service.MsgUpdateServiceBindingResponse"></a>
...
<a name="petrimod.service.MsgWithdrawEarnedFees"></a>
...
<a name="petrimod.service.MsgWithdrawEarnedFeesResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `DefineService` | [MsgDefineService](#petrimod.service.MsgDefineService) | [MsgDefineServiceResponse](#petrimod.service.MsgDefineServiceResponse) | DefineService defines a method for define a new service | |
| `BindService` | [MsgBindService](#petrimod.service.MsgBindService) | [MsgBindServiceResponse](#petrimod.service.MsgBindServiceResponse) | BindService defines a method for bind a server | |
| `UpdateServiceBinding` | [MsgUpdateServiceBinding](#petrimod.service.MsgUpdateServiceBinding) | [MsgUpdateServiceBindingResponse](#petrimod.service.MsgUpdateServiceBindingResponse) | UpdateServiceBinding defines a method for update a service binding | |
| `SetWithdrawAddress` | [MsgSetWithdrawAddress](#petrimod.service.MsgSetWithdrawAddress) | [MsgSetWithdrawAddressResponse](#petrimod.service.MsgSetWithdrawAddressResponse) | SetWithdrawAddress defines a method for setting a withdraw address | |
| `EnableServiceBinding` | [MsgEnableServiceBinding](#petrimod.service.MsgEnableServiceBinding) | [MsgEnableServiceBindingResponse](#petrimod.service.MsgEnableServiceBindingResponse) | EnableServiceBinding defines a method for enabling a service binding | |
| `DisableServiceBinding` | [MsgDisableServiceBinding](#petrimod.service.MsgDisableServiceBinding) | [MsgDisableServiceBindingResponse](#petrimod.service.MsgDisableServiceBindingResponse) | DisableServiceBinding defines a method for disabling a service binding | |
| `RefundServiceDeposit` | [MsgRefundServiceDeposit](#petrimod.service.MsgRefundServiceDeposit) | [MsgRefundServiceDepositResponse](#petrimod.service.MsgRefundServiceDepositResponse) | RefundServiceDeposit defines a method for refunding a fee | |
| `CallService` | [MsgCallService](#petrimod.service.MsgCallService) | [MsgCallServiceResponse](#petrimod.service.MsgCallServiceResponse) | CallService defines a method for calling a service | |
| `RespondService` | [MsgRespondService](#petrimod.service.MsgRespondService) | [MsgRespondServiceResponse](#petrimod.service.MsgRespondServiceResponse) | RespondService defines a method for responding a service | |
| `PauseRequestContext` | [MsgPauseRequestContext](#petrimod.service.MsgPauseRequestContext) | [MsgPauseRequestContextResponse](#petrimod.service.MsgPauseRequestContextResponse) | PauseRequestContext defines a method for pausing a service call | |
| `StartRequestContext` | [MsgStartRequestContext](#petrimod.service.MsgStartRequestContext) | [MsgStartRequestContextResponse](#petrimod.service.MsgStartRequestContextResponse) | StartRequestContext defines a method for starting a service call | |
| `KillRequestContext` | [MsgKillRequestContext](#petrimod.service.MsgKillRequestContext) | [MsgKillRequestContextResponse](#petrimod.service.MsgKillRequestContextResponse) | KillRequestContext defines a method for killing a service call | |
| `UpdateRequestContext` | [MsgUpdateRequestContext](#petrimod.service.MsgUpdateRequestContext) | [MsgUpdateRequestContextResponse](#petrimod.service.MsgUpdateRequestContextResponse) | UpdateRequestContext defines a method for updating a service call | |
| `WithdrawEarnedFees` | [MsgWithdrawEarnedFees](#petrimod.service.MsgWithdrawEarnedFees) | [MsgWithdrawEarnedFeesResponse](#petrimod.service.MsgWithdrawEarnedFeesResponse) | WithdrawEarnedFees defines a method for Withdrawing a earned fees | |
...
<a name="petrimod.token.Params"></a>
...
<a name="petrimod.token.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#petrimod.token.Params) |  |  |
| `tokens` | [Token](#petrimod.token.Token) | repeated |  |
...
<a name="petrimod.token.QueryFeesRequest"></a>
...
<a name="petrimod.token.QueryFeesResponse"></a>
...
<a name="petrimod.token.QueryParamsRequest"></a>
...
<a name="petrimod.token.QueryParamsResponse"></a>
...
<a name="petrimod.token.QueryTokenRequest"></a>
...
<a name="petrimod.token.QueryTokenResponse"></a>
...
<a name="petrimod.token.QueryTokensRequest"></a>
...
<a name="petrimod.token.QueryTokensResponse"></a>
...
<a name="petrimod.token.QueryTotalBurnRequest"></a>
...
<a name="petrimod.token.QueryTotalBurnResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `Token` | [QueryTokenRequest](#petrimod.token.QueryTokenRequest) | [QueryTokenResponse](#petrimod.token.QueryTokenResponse) | Token returns token with token name | GET|/petrimod/token/tokens/{denom}|
| `Tokens` | [QueryTokensRequest](#petrimod.token.QueryTokensRequest) | [QueryTokensResponse](#petrimod.token.QueryTokensResponse) | Tokens returns the token list | GET|/petrimod/token/tokens|
| `Fees` | [QueryFeesRequest](#petrimod.token.QueryFeesRequest) | [QueryFeesResponse](#petrimod.token.QueryFeesResponse) | Fees returns the fees to issue or mint a token | GET|/petrimod/token/tokens/{symbol}/fees|
| `Params` | [QueryParamsRequest](#petrimod.token.QueryParamsRequest) | [QueryParamsResponse](#petrimod.token.QueryParamsResponse) | Params queries the token parameters | GET|/petrimod/token/params|
| `TotalBurn` | [QueryTotalBurnRequest](#petrimod.token.QueryTotalBurnRequest) | [QueryTotalBurnResponse](#petrimod.token.QueryTotalBurnResponse) | TotalBurn queries all the burnt coins | GET|/petrimod/token/total_burn|
...
<a name="petrimod.token.MsgBurnToken"></a>
...
<a name="petrimod.token.MsgBurnTokenResponse"></a>
...
<a name="petrimod.token.MsgEditToken"></a>
...
<a name="petrimod.token.MsgEditTokenResponse"></a>
...
<a name="petrimod.token.MsgIssueToken"></a>
...
<a name="petrimod.token.MsgIssueTokenResponse"></a>
...
<a name="petrimod.token.MsgMintToken"></a>
...
<a name="petrimod.token.MsgMintTokenResponse"></a>
...
<a name="petrimod.token.MsgTransferTokenOwner"></a>
...
<a name="petrimod.token.MsgTransferTokenOwnerResponse"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `IssueToken` | [MsgIssueToken](#petrimod.token.MsgIssueToken) | [MsgIssueTokenResponse](#petrimod.token.MsgIssueTokenResponse) | IssueToken defines a method for issuing a new token | |
| `EditToken` | [MsgEditToken](#petrimod.token.MsgEditToken) | [MsgEditTokenResponse](#petrimod.token.MsgEditTokenResponse) | EditToken defines a method for editing a token | |
| `MintToken` | [MsgMintToken](#petrimod.token.MsgMintToken) | [MsgMintTokenResponse](#petrimod.token.MsgMintTokenResponse) | MintToken defines a method for minting some tokens | |
| `BurnToken` | [MsgBurnToken](#petrimod.token.MsgBurnToken) | [MsgBurnTokenResponse](#petrimod.token.MsgBurnTokenResponse) | BurnToken defines a method for burning some tokens | |
| `TransferTokenOwner` | [MsgTransferTokenOwner](#petrimod.token.MsgTransferTokenOwner) | [MsgTransferTokenOwnerResponse](#petrimod.token.MsgTransferTokenOwnerResponse) | TransferTokenOwner defines a method for minting some tokens | |
