...
This specification describes the usage and scope of random numbers on PETRIhub. This feature is currently in beta and please assess the risk yourself before using.

## Concepts

Currently, PETRIhub provides two random number generation methods: PRNG and TRNG.
...
On the basis of PRNG, the external random number factor `Oracle Seed` is introduced using the oracle machine method, implemented through PETRIhub Service.
