...
type OldHTLC struct {
	...
	State                HTLCStatus                               `protobuf:"varint,8,opt,name=state,proto3,enum=petrimod.htlc.HTLCStatus" json:"state,omitempty"`
}
...
func init() {
	proto.RegisterEnum("petrimod.htlc.HTLCStatus", HTLCStatus_name, HTLCStatus_value)
	proto.RegisterType((*OldHTLC)(nil), "petrimod.htlc.OldHTLC")
}
