...
Thank you for considering making contributions to GridIron!

Contributing to this repo can mean many things such as participated in
discussion or proposing code changes. To ensure a smooth workflow for all
contributors, the general procedure for contributing has been established:

  1. either [open](https://github.com/gridironprotocol/gridiron/issues/new) or
     [find](https://github.com/gridironprotocol/gridiron/issues) an issue you'd like to help with,
